...
310 LOCATE 1,17:? "ESCOLHA UMA OPCAO:"
320 LOCATE 27,21:OP$=INPUT$(1)
340 IF OP$="0" THEN RUN"AUTOEXEC.BAS"
350 ON VAL(OP$) GOSUB 400,500
360 GOTO 200
...
850 IF T%=3 THEN LOCATE 1,5:? "STRING (3 BYTES)"
