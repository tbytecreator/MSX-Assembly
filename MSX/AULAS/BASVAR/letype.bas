...
800 ' === EXIBE TIPO ===
810 GOSUB 1000
820 LOCATE 1,4:? "TIPO RETORNADO: ";T;" - ";
830 IF T=2 THEN LOCATE 1,5:? "INTEIRO (2 BYTES)"
840 IF T=3 THEN LOCATE 1,5:? "STRING"
850 IF T=4 THEN LOCATE 1,5:? "SINGLE (4 BYTES)"
860 IF T=8 THEN LOCATE 1,5:? "DOUBLE (8 BYTES)"
870 LOCATE 27,21:OP$=INPUT$(1)
880 RETURN
